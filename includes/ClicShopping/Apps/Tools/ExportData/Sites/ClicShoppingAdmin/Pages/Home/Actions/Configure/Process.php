  ...
  class Process extends \ClicShopping\OM\PagesActionsAbstract
  {
    public function execute()
    {
      ...
      foreach ($m->getParameters() as $key) {
        ...
        if (isset($_POST[$p])) {
          $CLICSHOPPING_ExportData->saveCfgParam($key, $_POST[$p]);
        }
      }

      $CLICSHOPPING_MessageStack->add($CLICSHOPPING_ExportData->getDef('alert_cfg_saved_success'), 'success', 'ExportData');
